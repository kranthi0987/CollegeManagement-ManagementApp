...
public class StaffAttendanceResponse implements Parcelable {

    public static final Creator<StaffAttendanceResponse> CREATOR = new Creator<StaffAttendanceResponse>() {
        @Override
        public StaffAttendanceResponse createFromParcel(Parcel in) {
            return new StaffAttendanceResponse(in);
        }

        @Override
        public StaffAttendanceResponse[] newArray(int size) {
            return new StaffAttendanceResponse[size];
        }
    };
    ...
    protected StaffAttendanceResponse(Parcel in) {
