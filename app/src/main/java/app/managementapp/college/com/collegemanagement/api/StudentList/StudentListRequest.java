...
public class StudentListRequest implements Parcelable {

    public static final Creator<StudentListRequest> CREATOR = new Creator<StudentListRequest>() {
        @Override
        public StudentListRequest createFromParcel(Parcel in) {
            return new StudentListRequest(in);
        }

        @Override
        public StudentListRequest[] newArray(int size) {
            return new StudentListRequest[size];
        }
    };
    ...
    protected StudentListRequest(Parcel in) {
